...
## Permasalahan 6
Ubahlah bilangan biner berikut menjadi bilangan desimal, sertakan langkah-langkahnya!\
a. 0101 1000\
b. 1000 0100
...
a. \
01011000\
0.2^7^ + 1.2^6^ + 0.2^5^ + 1.2^4^ + 1.2^3^ + 0.2^2^ + 0.2^1^ + 0.2^0^ \
0 + 64 + 16 + 8\
88

b.\
10000100\
1.2^7^ + 0.2^6^ + 0.2^5^ + 0.2^4^ + 0.2^3^ + 1.2^2^ + 0.2^1^ + 0.2^0^ \
128 + 4\
132
